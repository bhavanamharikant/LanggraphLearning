# Job Application Assistant - Parallel Analyses with Reducers (Scoring)
...
class ScreeningState(TypedDict):
    ...
    candidate_score: Annotated[float, operator.add]  # reducer (auto-sum)
...
# ✅ Node 1: Strengths (returns score + text)
...
# ✅ Node 2: Weaknesses (returns score + text)
...
# ✅ Output
print("\nFinal Candidate Score:", final_state["candidate_score"])
print("\nScreening Report:\n")
